...
(in other words, your YAML data structure should yield the following when read by Python).
Your YAML data structure should be written in expanded YAML format.
